...
public class AdminUsers {
    ...
    public String  getGcashNum()     { return gcashNum; }
    public String  getMayaNum()      { return mayaNum; }
    public String  getMastercardNum(){ return mastercardNum; }
    ...
    public void setGcashNum(String v)              { this.gcashNum = v; }
    public void setMayaNum(String v)               { this.mayaNum = v; }
    public void setMastercardNum(String v)         { this.mastercardNum = v; }
    public void setVisaNum(String v)               { this.visaNum = v; }
