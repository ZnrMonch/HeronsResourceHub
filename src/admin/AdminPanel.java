...
public class AdminPanel extends CustomPanel {
	...
	public AdminPanel() {
		...
		statusWrapper.add(generateStatusCard("/resources/icons/user-group.png", "Users", "Total Users", service.getTotalUsers(), Color.decode("#33277d")));
		statusWrapper.add(generateStatusCard("/resources/icons/items.png", "Items", "Total Items", service.getTotalItems(), Color.decode("#f9cb0f")));
		statusWrapper.add(generateStatusCard("/resources/icons/request.png", "Logs", "Total Transactions", service.getTotalTransactions(), Color.decode("#37ad00")));
		statusWrapper.add(generateStatusCard("/resources/icons/logs.png", "Logs", "Total Logs", service.getTotalLogs(), Color.decode("#37ad00")));

		contentWrapper.add(statusWrapper, BorderLayout.NORTH);
		contentWrapper.add(initTableManagement(service), BorderLayout.CENTER);
	...
	private CustomPanel initTableManagement(AdminService service) {
		...
		tabbedPane.addTab("USERS", "/resources/icons/home.png", new AdminTable(AdminTable.TableType.USERS, service));
		tabbedPane.addTab("ITEMS", "/resources/icons/items.png", new AdminTable(AdminTable.TableType.ITEMS, service));
		tabbedPane.addTab("USER LOGS", "/resources/icons/logs.png", new AdminTable(AdminTable.TableType.LOGS, service, "USER"));
		tabbedPane.addTab("ITEM LOGS", "/resources/icons/logs.png", new AdminTable(AdminTable.TableType.LOGS, service, "ITEM"));
		tabbedPane.addTab("TRANSACTION LOGS", "/resources/icons/logs.png", new AdminTable(AdminTable.TableType.LOGS, service, "TRANSACTION"));
		tabbedPane.addTab("REPUTATION LOGS", "/resources/icons/logs.png", new AdminTable(AdminTable.TableType.LOGS, service, "REPUTATION"));
