...
public abstract class BaseBrowsePanel extends CustomPanel {
	...
	// CONSTRUCTOR: Initializes UI layout, filter components, header toolbar,
	// listeners, and item display area
	public BaseBrowsePanel(UserRecord user, String searchPrompt, String actionText, MarketplaceTabMode tabMode) {
		...
		filterByPriceBox = new CustomComboBox<>(
				new String[] { "All Prices", "Free", "Under P500", "P500 - P1000", "Over P1000" });
	...
	// Forces a hard-refresh of the active item list data
	...
	// Reverts all search inputs and combo boxes back to default indexes
	...
	// Gathers active UI input values and sends them to the display panel logic
	...
	// Handles specific button logic implemented by child panels
